      ...
      <CardBody className="bg-white dark:from-gray-900 dark:to-black relative group/card border-2 border-[#1a56a7]/80 dark:border-white/[0.2] w-[360px] h-[520px] rounded-xl p-6 shadow-xl">
        ...
        >
          <span className="inline-flex items-center" dir="ltr">
            <span className="text-[#EE1D23]">RE</span>
            <span className="text-[#1a56a7]">/</span>
            <span className="text-[#EE1D23]">MAX</span>
            <span className="ml-2">
              <span className="text-[#1a56a7]">uni</span>
              <span className="text-[#EE1D23]">q</span>
              <span className="text-[#1a56a7]">ue</span>
            </span>
          </span>
        </CardItem>
